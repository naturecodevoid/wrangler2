 ...
 */
declare type TransformFn<T> = (fieldValue: T | undefined) => T | undefined;
/**
 ...
 */
export declare type ValidatorFn = (diagnostics: Diagnostics, field: string, value: unknown, topLevelEnv: Environment | undefined) => boolean;
/**
 ...
 */
declare type TypeofType = "string" | "number" | "bigint" | "boolean" | "symbol" | "undefined" | "object" | "function";
export {};
