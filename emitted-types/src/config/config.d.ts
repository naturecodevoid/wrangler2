 ...
 */
export declare type Config = ConfigFields<DevConfig> & Environment;
export declare type RawConfig = Partial<ConfigFields<RawDevConfig>> & RawEnvironment & DeprecatedConfigFields & EnvironmentMap;
...
export declare type RawDevConfig = Partial<DevConfig>;
...
export declare type OnlyCamelCase<T = Record<string, never>> = {
