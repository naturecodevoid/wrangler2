...
export declare type SimpleRoute = string;
export declare type ZoneIdRoute = {
    pattern: string;
    zone_id: string;
    custom_domain?: boolean;
};
export declare type ZoneNameRoute = {
    pattern: string;
    zone_name: string;
    custom_domain?: boolean;
};
export declare type CustomDomainRoute = {
    pattern: string;
    custom_domain: boolean;
};
export declare type Route = SimpleRoute | ZoneIdRoute | ZoneNameRoute | CustomDomainRoute;
/**
...
export declare type DurableObjectBindings = {
 ...
 */
export declare type RawEnvironment = Partial<Environment> & EnvironmentDeprecated;
/**
 ...
 */
export declare type ConfigModuleRuleType = "ESModule" | "CommonJS" | "CompiledWasm" | "Text" | "Data";
export {};
