 ...
 * The type of Worker
 */
export declare type CfScriptFormat = "modules" | "service-worker";
/**
 * A module type.
 */
export declare type CfModuleType = "esm" | "commonjs" | "compiled-wasm" | "text" | "buffer";
/**
 * An imported module.
 */
...
export declare const D1_BETA_PREFIX: "__D1_BETA__";
export declare type D1PrefixedBinding = `${typeof D1_BETA_PREFIX}${string}`;
...
export declare function identifyD1BindingsAsBeta(dbs: Environment["d1_databases"]): CfD1Database[] | undefined;
export declare function removeD1BetaPrefix(binding: D1PrefixedBinding): string;
export {};
